...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Base Station'); ?> - TENGGANGLOPI</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="nav-menu">
            ...
            <a href="<?php echo e(route('superadmin.dashboard')); ?>" class="nav-item <?php echo e(request()->routeIs('superadmin.dashboard') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('superadmin.tracking')); ?>" class="nav-item <?php echo e(request()->routeIs('superadmin.tracking') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('superadmin.history')); ?>" class="nav-item <?php echo e(request()->routeIs('superadmin.history') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('superadmin.administration.fishermen')); ?>" class="nav-item <?php echo e(request()->routeIs('superadmin.administration.fishermen') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('superadmin.administration.accounts')); ?>" class="nav-item <?php echo e(request()->routeIs('superadmin.administration.accounts') ? 'active' : ''); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><circle cx="10" cy="7" r="4"></circle><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                Kelola Akun
            </a>
            <a href="<?php echo e(route('superadmin.settings')); ?>" class="nav-item <?php echo e(request()->routeIs('superadmin.settings') ? 'active' : ''); ?>">
    ...
    <!-- User Profile Footer -->
        <div class="sidebar-footer">
            <div class="user-profile-sidebar">
                <div class="avatar">
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name)); ?>&background=262933&color=E2E8F0" alt="Avatar">
                </div>
                <div class="user-info">
        ...
        <div class="topbar">
            <div class="topbar-left" style="display: flex; align-items: center; gap: 15px;">
                ...
                <div>
                    ...
                    <p><?php echo $__env->yieldContent('subtitle', 'System Status: Healthy'); ?></p>
                </div>
            </div>
            <div style="display: flex; align-items: center; gap: 20px;">
                ...
                <div class="role-badge" style="align-self: center;"><?php echo e(Auth::user()->role ?? 'Superadmin'); ?></div>
            </div>
        </div>
...
<?php /**PATH D:\UNSULBAR\PEMROGRAMAN\laragon\www\TENGGANGLOPI\resources\views/layouts/superadmin.blade.php ENDPATH**/ ?>