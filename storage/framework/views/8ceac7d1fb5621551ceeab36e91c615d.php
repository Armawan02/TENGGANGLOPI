...
<?php $__env->startSection('subtitle', 'Pusat Komando & Pemantauan Darurat'); ?>
...
<script>
    ...
    function fetchFleetData() {
        fetch("<?php echo e(route('api.fleet.all')); ?>")
            .then(res => res.json())
            .then(response => {
    ...
    function triggerBuzzer() {
        ...
        fetch("<?php echo e(route('api.fleet.buzzer')); ?>", {
            method: 'POST',
            headers: {
    ...
    function fetchRecentLogs() {
        fetch("<?php echo e(route('api.history.logs')); ?>")
            .then(res => res.json())
            .then(response => {
                if (response.status === 'success') {
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UNSULBAR\PEMROGRAMAN\laragon\www\TENGGANGLOPI\resources\views/superadmin/dashboard.blade.php ENDPATH**/ ?>