...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('isc.png')); ?>">
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero {
            ...
            background-image: linear-gradient(rgba(15, 23, 42, 0.65), rgba(15, 23, 42, 0.75)), url('<?php echo e(asset("bg-tengganglopi.jpg")); ?>');
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-content-wrapper">
            <a href="/" class="nav-logo">
                <img src="<?php echo e(asset('hero.png')); ?>" alt="Logo TENGGANGLOPI">
            </a>
            <div class="nav-links">
            ...
            <a href="<?php echo e(route('login')); ?>" class="btn-login">Login Akses</a>
        </div>
    </nav>
    ...
    <section id="beranda" class="hero">
        ...
        <div class="hero-content">
            <img src="<?php echo e(asset('logo.png')); ?>" alt="TENGGANG LOPI" class="hero-logo">
    ...
    <!-- Footer -->
    <footer>
        <p>&copy; <?php echo e(date('Y')); ?> TENGGANG LOPI Research Project. All rights reserved.</p>
    </footer>
...
<?php /**PATH D:\UNSULBAR\PEMROGRAMAN\laragon\www\TENGGANGLOPI\resources\views/guest/index.blade.php ENDPATH**/ ?>