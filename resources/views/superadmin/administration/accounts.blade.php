    ...
    <div class="account-card">
        <div class="account-header">
            <div class="account-avatar">
                <img src="https://ui-avatars.com/api/?name={{ urlencode($account['name'] ?? 'User') }}&background=E2E8F0&color=2563EB" alt="Avatar" style="width:100%;height:100%;border-radius:50%;">
            </div>
        ...
        <div class="account-actions">
            ...
            <div class="row-actions">
                <button class="btn-action btn-edit" onclick="openEditModal('{{ $account['id'] }}', '{{ $account['name'] ?? '' }}', '{{ $account['email'] ?? '' }}', '{{ $account['role'] ?? '' }}', '{{ $account['phone'] ?? '' }}')">
...
<div class="modal" id="addModal">
    <div class="modal-content">
        ...
        <form action="{{ route('superadmin.administration.accounts.store') }}" method="POST">
            @csrf
