...
<div class="log-panel">
    <div class="log-panel-header" style="justify-content: space-between;">
        ...
        <a href="{{ route('petugas.history') }}" style="font-size: 11px; padding: 6px 12px; background: rgba(0,0,0,0.03); color: var(--text-primary); border-radius: 6px; text-decoration: none; border: 1px solid var(--border-color); text-transform: none; font-weight: 500; letter-spacing: 0; transition: background 0.2s;" onmouseover="this.style.background='rgba(0,0,0,0.08)'" onmouseout="this.style.background='rgba(0,0,0,0.03)'">Lihat Semua</a>
    </div>
