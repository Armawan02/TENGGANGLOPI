...
<head>
    ...
    <title>@yield('title', 'Base Station') - TENGGANGLOPI</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="nav-menu">
            ...
            <a href="{{ route('superadmin.tracking') }}" class="nav-item {{ request()->routeIs('superadmin.tracking') ? 'active' : '' }}">
            ...
            <a href="{{ route('superadmin.history') }}" class="nav-item {{ request()->routeIs('superadmin.history') ? 'active' : '' }}">
            ...
            <a href="{{ route('superadmin.administration.fishermen') }}" class="nav-item {{ request()->routeIs('superadmin.administration.fishermen') ? 'active' : '' }}">
            ...
            <a href="{{ route('superadmin.administration.accounts') }}" class="nav-item {{ request()->routeIs('superadmin.administration.accounts') ? 'active' : '' }}">
