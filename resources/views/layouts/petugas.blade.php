                    ...
                    if (totalCount > 0) {
                        ...
                        if (alertCount > 0) {
                            alertRes.data.forEach(alert => {
                                html += `<a href="/petugas/history" style="text-decoration: none; display: block; padding: 15px 20px; border-bottom: 1px solid var(--border-color); background: rgba(239, 68, 68, 0.1); display: flex; gap: 10px; align-items: start; transition: 0.2s;" onmouseover="this.style.background='rgba(239, 68, 68, 0.15)'" onmouseout="this.style.background='rgba(239, 68, 68, 0.1)'">
                        ...
                        // 3. Pending Users (Biasanya 0 untuk petugas, tapi kalau ada tampilkan tanpa link agar aman)
                        if (pendingCount > 0) {
                            html += `<div style="padding: 15px 20px; border-bottom: 1px solid var(--border-color); background: rgba(59, 130, 246, 0.05); display: flex; gap: 10px; align-items: start;">
                                ...
                                <div>
                                    ...
                                    <div style="font-size: 11px; color: var(--text-muted); margin-top: 3px;">Terdapat ${pendingCount} pengguna baru yang menunggu persetujuan Superadmin.</div>
                                </div>
                            </div>`;
                        }
